...
class Other_SVG_Indicator extends SVG_Indicator {
    constructor (container: HTMLDivElement,max_child_elem_count: number,tooltip_text = "Generic",tooltip_position: _TOOLTIP_POSITION_ = "left") {
        super(container,max_child_elem_count,tooltip_text);
...
class CreateCross_SVG_Indicator extends Other_SVG_Indicator {
    constructor (container: HTMLDivElement,text: string,tooltip_postition: _TOOLTIP_POSITION_ = "left") {
...
class CreateToolTip {
    ...
    constructor (tooltip_container: HTMLDivElement,tooltip: HTMLElement,tooltip_text: string,vert_padding = 5,width: number) {
