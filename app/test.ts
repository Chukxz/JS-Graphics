...
class Quarternion {
  ...
  const prevN = [0,0,1];
  const newN = [ -0.5773502691896257, -0.5773502691896257, 0.5773502691896257 ]
  ...
  const ang = 54.735610317245346;

  const crossP = [ 0.5773502691896257, -0.5773502691896257, 0 ];
  const crossPNeg = [ -0.7071067811865475, 0.7071067811865475, 0 ];
})()
