...
const _app_drop = document.getElementById("main_drop") as HTMLDivElement;
var _app_drop_v = false;
const _app_drop_content = document.getElementById("main_drop_c") as HTMLDivElement;

const _app_canvas = document.getElementsByTagName('canvas')[0];


const _app_ctx = _app_canvas.getContext('2d',{ willReadFrequently: true }) as CanvasRenderingContext2D;
const _app_main_status = document.getElementById("status") as HTMLElement;

const _app_anim_number = document.getElementById("anim1_value") as HTMLElement;
const _app_anim_number_input = document.getElementById("animation_number") as HTMLInputElement;

const _app_anim_speed = document.getElementById("anim2_value") as HTMLElement;
const _app_anim_speed_input = document.getElementById("animation_speed") as HTMLInputElement;

const _app_anim_info_btn = document.getElementById("anim_info") as HTMLButtonElement;

const _app_after_anim1 = document.getElementById("after_anim1") as HTMLElement;

const _app_c_1 = document.getElementById("c_1") as HTMLButtonElement;
const _app_c_2 = document.getElementById("c_2") as HTMLButtonElement;
const _app_c_3 = document.getElementById("c_3") as HTMLButtonElement;
const _app_c_elems = document.getElementsByClassName("cdv_elem") as HTMLCollectionOf<HTMLButtonElement>;
...
class BasicSettings {
    ...
    constructor () {
        (_app_drop as HTMLElement).style.top = `${-(_app_drop as HTMLElement).offsetTop + _app_canvas.offsetTop}px`;
        this.setCanvas();
        ...
        _app_drop.addEventListener("mouseover",() => { if(_app_drop_v === false) _app_drop_content.style.display = "inline-block" });
        _app_drop.addEventListener("mouseout",() => { if(_app_drop_v === false) _app_drop_content.style.display = "none" });
